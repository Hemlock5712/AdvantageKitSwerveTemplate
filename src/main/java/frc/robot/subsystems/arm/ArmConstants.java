...
public class ArmConstants {
  private static final TunableNumberWrapper tunable = new TunableNumberWrapper(ArmConstants.class);

  public static final int LEFT_MOTOR_ID = 9;
  public static final int RIGHT_MOTOR_ID = 10;
  public static final LoggedTunableNumber kS = tunable.makeField("kS", .1); // todo tune
  public static final LoggedTunableNumber kP = tunable.makeField("kP", 4); // todo tune
  public static final LoggedTunableNumber kI = tunable.makeField("kI", 0.0); // todo tune
  public static final LoggedTunableNumber kD = tunable.makeField("kD", 0); // todo tune
  ...
  public static final LoggedTunableNumber MAX_ARM_PID_VOLTS =
      tunable.makeField("max arm pid volts", 4.0);
  public static final LoggedTunableNumber MANUAL_ARM_MAX_VOLTS =
      tunable.makeField("max arm manual volts", 2.0);

  // public static final int UPPER_LIMIT_SWITCH_PORT = 5;
  // public static final int LOWER_LIMIT_SWITCH_PORT = 6;

  public static class Positions {
    public static final LoggedTunableNumber INTAKE_POS_RAD = tunable.makeField("Intake pos", 0);
    public static final LoggedTunableNumber SPEAKER_POS_RAD =
        tunable.makeField("speaker pos", 0.2); // todo tune
    public static final LoggedTunableNumber AMP_POS_RAD =
        tunable.makeField("amp pos", Units.degreesToRadians(90)); // todo tune
  }
